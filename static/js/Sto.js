...
$(function () {
	...
	uploadBtn.on('change', function (e) {
		...
		if (files.size > MAX_SIZE) {
			...
			$('.file-name', totalRow).text('onii-chan y-your upload is t-too big')
			return
		}

		var up = files.upload("/api/upload")
		...
		up.on('load', function (e, res) {
			switch (e.target.status) {
				...
				case 413:
					...
					totalName.html($('<div/>').html('onii-chan, y-your upload is t-too big!').text());
					break
				default:
					uploadFiles.addClass('error completed')
